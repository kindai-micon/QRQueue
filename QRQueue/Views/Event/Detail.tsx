    ...
    return (
        <Layout>
            <style>{`
                ...
                .link-card {
                    display: block; padding: 1rem 1.5rem; border-radius: 0.75rem;
                    background: #f9f9f9; border: 1px solid #ddd; transition: all 0.2s ease;
                    text-decoration: none; color: #333; font-size: 1.1rem; font-weight: 500;
                }
                .link-card:hover {
                    background: #e9f5ff; border-color: #007acc; box-shadow: 0 2px 8px rgba(0,0,0,0.08);
                }
